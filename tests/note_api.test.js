...
const api = supertest(app) //figure out what is is use for
...
describe('viewing a specific note', () => {
    ...
    test('fails with statuscode 400 id is invalid', async () => {
        const invalidId = '6353ce0160549ca9517b5b8'
...
describe('adition of a new note', () => {
    test('succeeds wiht a valid data', async () => {
        const newNote = {
...
describe('deletion of a note', () => {
    test('succeeds with sattus code 204 if id is valid', async () => {
        const notesAtStart = await helper.notesInDb()
